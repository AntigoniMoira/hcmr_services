export default {
    home:{
        ...
        platforms_between: 'http://poseidonsystem.gr:8000/api/poseidon_platforms_with_measurements_between/',
        measurements_between: 'http://poseidonsystem.gr:8000/api/poseidon_platform_parameters_with_measurements_between/',
